...
A WebAssembly build environment is required. You can download it (for Windows) here: [wasm-build-tools-win](releases/download/wasm-build-tools/wasm-build-tools-win.zip).
